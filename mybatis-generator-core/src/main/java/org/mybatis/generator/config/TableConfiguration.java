...
public class TableConfiguration extends PropertyHolder {
    ...
    /** 高新区项目 扩展是否启用 statement enabled. */
    private boolean gxqptExtStatementEnabled;
    private boolean gxqptAppIdEnabled;
    ...
    public TableConfiguration(Context context) {
        ...
        gxqptExtStatementEnabled = true;
        gxqptAppIdEnabled = true;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (!gxqptExtStatementEnabled) {
            xmlElement.addAttribute(new Attribute("gxqptExtStatementEnabled", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        if (!gxqptAppIdEnabled) {
            xmlElement.addAttribute(new Attribute("gxqptAppIdEnable", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
    ...
    public boolean isGxqptExtStatementEnabled() {
        return gxqptExtStatementEnabled;
    }
    public boolean isGxqptAppIdEnabled() {
        return gxqptAppIdEnabled;
    }
    ...
    public void setGxqptExtStatementEnabled(
            boolean gxqptExtStatementEnabled) {
        this.gxqptExtStatementEnabled = gxqptExtStatementEnabled;
    }
    public void setGxqptAppIdEnabled(
            boolean gxqptAppIdEnabled) {
        this.gxqptAppIdEnabled = gxqptAppIdEnabled;
    }
