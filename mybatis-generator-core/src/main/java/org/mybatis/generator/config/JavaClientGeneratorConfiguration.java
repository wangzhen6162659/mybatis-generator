...
public class JavaClientGeneratorConfiguration extends TypedPropertyHolder {
    ...
    private String targetIsGenMethod;
    ...
    public String getTargetIsGenMethod() {
        return targetIsGenMethod;
    }

    public void setTargetIsGenMethod(String targetIsGenMethod) {
        this.targetIsGenMethod = targetIsGenMethod;
    }
    ...
    public XmlElement toXmlElement() {
        ...
        if (targetSuperClass != null) {
            answer.addAttribute(new Attribute("targetSuperClass", targetSuperClass)); //tangyh
        }

        if (targetIsGenMethod != null) {
            answer.addAttribute(new Attribute("targetIsGenMethod", targetIsGenMethod)); //tangyh
        }

        if (targetSuperGeneric != null) {
            answer.addAttribute(new Attribute("targetSuperGeneric", targetSuperGeneric)); //tangyh
        }
